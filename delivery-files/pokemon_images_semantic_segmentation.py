...
from libs.images_set_generator import generate_images_sets
...
from libs.parameters_and_arguments import TENSORFLOW_KERAS_HPC_BACKEND_SESSION

# Import the Number of CPU's Processors/Cores
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_CPU_PROCESSORS_CORES

# Import the Number of GPU's Devices
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_GPU_DEVICES

# Import the Number of Examples (Images/Masks) for the final Training Set
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_EXAMPLES_FINAL_TRAINING_SET

# Import the Number of Examples (Images/Masks) for the final Validation Set
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_EXAMPLES_FINAL_VALIDATION_SET

# Import the Number of Filters for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import IMAGES_HEIGHT

# Import the Number of Filters for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import IMAGES_WIDTH

# Import the Number of Filters for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_CHANNELS_RGB

# Import the Number of Filters for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_CHANNELS_GRAY_SCALE

# Import the Number of Filters for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_FILTERS_PER_BLOCK
...
# # from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import KERNEL_RGB_HEIGHT

# Import the Width of the Kernel of the Filters, for RGB Colors,
# used for the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import KERNEL_RGB_WIDTH

# Import the Height of the Kernel of the Filters, for Gray Scale Colors,
# # used for the Model of the feed-forward Convolution Neural Network (C.N.N.)
# # from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import KERNEL_GRAY_SCALE_HEIGHT

# Import the Width of the Kernel of the Filters, for Gray Scale Colors,
# used for the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import KERNEL_GRAY_SCALE_WIDTH

# Import the Height of the Pooling Matrix #2 used for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import POOLING_HEIGHT_2

# Import the Width of the Pooling Matrix #2 used for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import POOLING_WIDTH_2

# Import the Height of the Stride used on
# the Pooling Matrices used for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import STRIDE_HEIGHT

# Import the Width of the Stride used on
# the Pooling Matrices used for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import STRIDE_WIDTH

# Import the Height of the Tuple Sampling used on
# the Pooling Matrices used for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import TUPLE_SAMPLING_HEIGHT

# Import the Width of the Tuple Sampling used on
# the Pooling Matrices used for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import TUPLE_SAMPLING_WIDTH

# Import the Optimisers available to use for the the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import AVAILABLE_OPTIMISERS_LIST

# Import the Number of Optimisers available to use for the the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_AVAILABLE_OPTIMISERS

# Import the Learning Rates for the Optimisers used for
# the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import INITIAL_LEARNING_RATES

# Import the Momentum #1 for the Optimisers used for
# the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import MOMENTUM_1

# Import the Momentum #2 for the Optimiser used for
# the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import MOMENTUM_2

# Import the Decay #1 for the Optimisers used for
# the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import DECAY_1

# Import the Number of Epochs #2 for the Optimiser for
# the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_EPOCHS_2

# Import the Size of the Batch for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import BATCH_SIZE_1
...
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.preprocessing_utils import retrieve_datasets_from_pokemon_data
...
from libs.preprocessing_utils import \
...
from libs.visualization_plotting import \
...
from tp1_utils import compare_masks as compare_true_and_predicted_masks

# Import the Auxiliary Function to
# Overlay the True Testing Masks with the Predicted Masks,
# for the Project, from the TP1_Utils' Python's Module,
# with the overlay_true_and_predicted_masks alias
from tp1_utils import overlay_masks as overlay_true_and_predicted_masks

# Import the Auxiliary Function to
# to convert Images to Pictures,
# for the Project, from the TP1_Utils' Python's Module,
# with the overlay_true_and_predicted_masks alias
from tp1_utils import images_to_pic as images_to_pic
...
def execute_model_of_semantic_segmentation_for_all_available_optimisers(final_choice=None):
    ...
    for num_optimiser in range(NUM_AVAILABLE_OPTIMISERS):
        ...
        if (AVAILABLE_OPTIMISERS_LIST[num_optimiser] == final_choice) and (final_choice is not None):
            ...
            # the Model for the feed-forward Convolution Neural Network (C.N.N.)
            cnn_model_in_keras_functional_api_for_semantic_segmentation_masking \
                .save_weights('pokemon-semantic-segmentation-training-history-%s-optimiser-%s-weights.h5'
            ...
            with open('pokemon-semantic-segmentation-training-history-%s-optimiser-%s-weights.json'
            ...
            images_to_pic(('pokemon-semantic-segmentation-masks-%s-optimiser.png'
                           % (AVAILABLE_OPTIMISERS_LIST[num_optimiser].lower())),
                          ys_masks_testing_set_pokemon_predicted)

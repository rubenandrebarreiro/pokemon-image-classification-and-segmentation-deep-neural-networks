...
# The final choice for the Multi-Class Classification
FINAL_CHOICE_MULTI_CLASS_CLASSIFICATION = 'ADAM'

# The final choice for the Multi-Label Classification
FINAL_CHOICE_MULTI_LABEL_CLASSIFICATION = 'ADAM'

# The final choice for the Semantic Segmentation
FINAL_CHOICE_SEMANTIC_SEGMENTATION_CLASSIFICATION = 'ADAM'
...
optimisers_training_loss_means_multi_class, \
    ...
    execute_model_of_multi_class_classification_for_all_available_optimisers(FINAL_CHOICE_MULTI_CLASS_CLASSIFICATION)
...
optimisers_training_loss_means_multi_label, \
    ...
    execute_model_of_multi_label_classification_for_all_available_optimisers(FINAL_CHOICE_MULTI_LABEL_CLASSIFICATION)
...
optimisers_training_loss_means_semantic_segmentation, \
    ...
    execute_model_of_semantic_segmentation_for_all_available_optimisers(
        FINAL_CHOICE_SEMANTIC_SEGMENTATION_CLASSIFICATION
    )
...
optimisers_training_loss_means_mobile_net_multi_class, \
    ...
    execute_mobile_net_model_multi_class_classification_for_all_available_optimisers(
        FINAL_CHOICE_MULTI_CLASS_CLASSIFICATION
    )
...
optimisers_training_loss_means_mobile_net_multi_label, \
    ...
    execute_mobile_net_model_multi_label_classification_for_all_available_optimisers(
        FINAL_CHOICE_MULTI_LABEL_CLASSIFICATION
    )
...
for num_optimiser in range(NUM_AVAILABLE_OPTIMISERS):
    ...
    if (AVAILABLE_OPTIMISERS_LIST[num_optimiser] == FINAL_CHOICE_MULTI_CLASS_CLASSIFICATION) and \
        ...
        print(' - %s: [ train_loss = %.12f ; train_acc = %.12f |'
              ...
              ' test_loss = %.12f ; test_acc = %.12f ]'
              % (AVAILABLE_OPTIMISERS_LIST[num_optimiser],
                 optimisers_training_loss_means_mobile_net_multi_class[0],
                 optimisers_training_accuracy_means_mobile_net_multi_class[0],
                 optimisers_validation_loss_means_mobile_net_multi_class[0],
                 optimisers_validation_accuracy_means_mobile_net_multi_class[0],
                 optimisers_true_testing_loss_means_mobile_net_multi_class[0],
                 optimisers_true_testing_accuracy_means_mobile_net_multi_class[0]))
...
for num_optimiser in range(NUM_AVAILABLE_OPTIMISERS):
    ...
    if (AVAILABLE_OPTIMISERS_LIST[num_optimiser] == FINAL_CHOICE_MULTI_LABEL_CLASSIFICATION) and \
        ...
        print(' - %s: [ train_loss = %.12f ; train_acc = %.12f |'
              ...
              ' test_loss = %.12f ; test_acc = %.12f ]'
              % (AVAILABLE_OPTIMISERS_LIST[num_optimiser],
                 optimisers_training_loss_means_mobile_net_multi_label[0],
                 optimisers_training_accuracy_means_mobile_net_multi_label[0],
                 optimisers_validation_loss_means_mobile_net_multi_label[0],
                 optimisers_validation_accuracy_means_mobile_net_multi_label[0],
                 optimisers_true_testing_loss_means_mobile_net_multi_label[0],
                 optimisers_true_testing_accuracy_means_mobile_net_multi_label[0]))

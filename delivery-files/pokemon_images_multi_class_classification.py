...
Module for the Multi-Class Classification Problem in the Project
...
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import POOLING_HEIGHT_1

# Import the Width of the Pooling Matrix used for the Model of
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import POOLING_WIDTH_1
...
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_UNITS_LAST_DENSE_LAYER_1
...
# the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_EPOCHS_1
...
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_CLASSES_POKEMON_TYPES
...
def create_cnn_model_in_keras_sequential_api_for_image_classification(optimiser_id):
    ...
    convolution_neural_network_tensorflow_keras_sequential_model = \
        Sequential(name='pokemon-images-multi-class-classification')
...
# Function to execute the Model of Multi-Class Classification for all the Available Optimisers
def execute_model_of_multi_class_classification_for_all_available_optimisers(final_choice=None):
    ...
    for num_optimiser in range(NUM_AVAILABLE_OPTIMISERS):
        ...
        if (AVAILABLE_OPTIMISERS_LIST[num_optimiser] == final_choice) and (final_choice is not None):
            ...
            # the Model for the feed-forward Convolution Neural Network (C.N.N.)
            cnn_model_in_keras_sequential_api_for_image_classification_multi_classes_classification \
                .save_weights('pokemon-image-classification-training-history-multi-classes-%s-optimiser-'
                              '%s-weights.h5'
            ...
            with open('pokemon-image-classification-training-history-multi-classes-%s-optimiser-%s-weights.json'
    ...
    plot_subset_metric_all_optimisers(optimisers_training_loss_history,
                                      ...
                                      'Multi-Class', final_choice=final_choice)

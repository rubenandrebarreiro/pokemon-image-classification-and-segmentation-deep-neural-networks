...
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import NUM_UNITS_LAST_DENSE_LAYER_2
...
# the Model of the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import DECAY_2
...
# the feed-forward Convolution Neural Network (C.N.N.)
# from the Parameters and Arguments Python's Custom Module
from libs.parameters_and_arguments import BATCH_SIZE_2
...
def execute_mobile_net_model_multi_class_classification_for_all_available_optimisers(final_choice):
    ...
    for num_optimiser in range(NUM_AVAILABLE_OPTIMISERS):
        ...
        if (AVAILABLE_OPTIMISERS_LIST[num_optimiser] == final_choice) and (final_choice is not None):
            ...
            with open('pokemon-image-classification-training-history-multi-classes-%s-optimiser-'
    ...
    plot_subset_metric_all_optimisers(optimisers_training_loss_history,
                                      ...
                                      'Multi-Class', image_net_pre_trained=True, final_choice=final_choice)
...
def execute_mobile_net_model_multi_label_classification_for_all_available_optimisers(final_choice):
    ...
    for num_optimiser in range(NUM_AVAILABLE_OPTIMISERS):
        ...
        if (AVAILABLE_OPTIMISERS_LIST[num_optimiser] == final_choice) and (final_choice is not None):
            ...
            # the Model for the feed-forward Convolution Neural Network (C.N.N.)
            fine_tuned_cnn_model_in_keras_functional_api_for_image_classification_multi_labels_classification \
                .save_weights('pokemon-image-classification-training-history-multi-labels-'
            ...
            # Write the Model for the feed-forward Convolution Neural Network (C.N.N.) to a JSON Object
            with open('pokemon-image-classification-training-history-multi-labels-'
        ...
        # Execute all the Optimisers
            ...
            # Retrieve the History of the Training Accuracies for the current Optimiser
            optimiser_training_accuracy_history = \
                cnn_model_in_keras_sequential_api_for_image_classification_training_history.history[
                    'binary_accuracy']
    ...
    plot_subset_metric_all_optimisers(optimisers_training_loss_history,
                                      'Training', 'Loss', now_date_time,
                                      'Multi-Label', image_net_pre_trained=True, final_choice=final_choice)

...
from project.tp1.tp1_utils import images_to_pic
...
def generate_images_sets(xs_features_training_set_pokemon, xs_masks_training_set_pokemon,
    ...
    images_to_pic('files\\images\\figures\\training\\pokemons\\pokemons-training-set-images.png',
                  xs_features_training_set_pokemon)

    # Generate the Figure with the Images, from the xs (masks) of the Training Set
    images_to_pic('files\\images\\figures\\training\\masks\\pokemons-masks-training-set-images.png',
                  xs_masks_training_set_pokemon)

    # Generate the Figure with the Images, from the xs (features) of the Training Augmented Set
    images_to_pic('files\\images\\figures\\training\\pokemons\\pokemons-training-augmented-set-images.png',
    ...
    images_to_pic('files\\images\\figures\\training\\masks\\pokemons-masks-training-augmented-set-images.png',
    ...
    images_to_pic('files\\images\\figures\\validation\\pokemons\\pokemons-validation-set-images.png',
                  xs_features_validation_set_pokemon)

    # Generate the Figure with the Images, from the xs (masks) of the Validation Set
    images_to_pic('files\\images\\figures\\validation\\masks\\pokemons-masks-validation-set-images.png',
                  xs_masks_validation_set_pokemon)

    # Generate the Figure with the Images, from the xs (features) of the Validation Augmented Set
    images_to_pic('files\\images\\figures\\validation\\pokemons\\pokemons-validation-augmented-set-images.png',
    ...
    images_to_pic('files\\images\\figures\\validation\\masks\\pokemons-masks-validation-augmented-set-images.png',
    ...
    images_to_pic('files\\images\\figures\\testing\\pokemons\\pokemons-testing-set-images.png',
                  xs_features_testing_set_pokemon)

    # Generate the Figure with the Images, from the xs (masks) of the Testing Set
    images_to_pic('files\\images\\figures\\testing\\masks\\pokemons-masks-testing-set-images.png',
